...
# prompt = "Tell me information about local policing in the North East of England"
if prompt:
    st.chat_message("user").markdown(prompt)
    st.session_state.messages.append({"role": "user", "content": prompt})

    response = f"{get_summary(prompt, subject, region, news_source, description)}"
